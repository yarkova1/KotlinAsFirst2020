 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int) = (16 * arshins + 48 * sagenes + vershoks) * 0.04445
 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int) = (PI / 180) * (deg + min.toDouble() / 60 + sec.toDouble() / 3600)
